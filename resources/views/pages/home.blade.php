    ...
    <div class="rounded-3xl p-8 md:p-12 relative overflow-hidden"
        ...
        <div class="relative z-10 max-w-lg">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('menu') }}" class="px-6 py-3 rounded-xl font-semibold text-sm transition hover:opacity-90" style="background: #fff; color: #8B5E3C;">
                    Pesan Sekarang
                </a>
                <a href="{{ route('booking.create') }}" class="px-6 py-3 rounded-xl font-semibold text-sm transition border" style="border-color: rgba(255,255,255,0.5); color: #fff;">
                    Booking Meja
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-3 gap-3">
        @php
            $infoItems = [
                ...
                ['icon' => '📍', 'label' => 'Lokasi', 'value' => 'Jl. Nusantara No. 12'],
                ['icon' => '⭐', 'label' => 'Rating', 'value' => '4.8 / 5.0 ⭐'],
            ];
        @endphp
        @foreach($infoItems as $info)
        <div class="bg-white rounded-2xl p-4 flex flex-col items-center text-center gap-1 shadow-sm" style="border: 1px solid #F0E8DF;">
