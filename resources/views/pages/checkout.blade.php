    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm" style="border: 1px solid #F0E8DF;">
            ...
            <form id="checkout-form" class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <textarea id="address" placeholder="Tuliskan alamat lengkap pengiriman" rows="2" class="input-field resize-none" required></textarea>
                    <button type="button" onclick="getLocation()" class="text-xs font-semibold mt-1 flex items-center gap-1 w-fit px-3 py-1.5 rounded-lg border transition hover:bg-gray-50 text-gray-500" style="border-color: #ddd;">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <textarea id="note" placeholder="Catatan untuk dapur..." rows="2" class="input-field resize-none"></textarea>
                </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm h-fit" style="border: 1px solid #F0E8DF;">
            ...
            <div class="mt-4 p-3 bg-blue-50 text-blue-800 rounded-xl text-xs flex gap-2">
                <svg class="w-5 h-5 flex-shrink-0 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <p>Harga pesanan akan dikonfirmasi lebih lanjut oleh pihak kami. Kami tidak mengirimkan harga ke pesan WhatsApp demi menjaga keamanan transaksi.</p>
            </div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.addEventListener('submit', async function(e) {
                ...
                // URL WA
                const adminPhone = '6281234567890'; // Ganti dengan nomor yang sesuai jika ada
